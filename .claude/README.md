...
- [2026-01-16 前端项目搭建](./sessions/2026-01/16-frontend-setup.md)
- [2026-01-19 聊天面板开发](./sessions/2026-01/19-chat-panel.md)
- [2026-01-20 Lighthouse 性能优化](./sessions/2026-01/20-lighthouse-optimization.md)
- [2026-01-21 登录功能与 UI 优化](./sessions/2026-01/21-login-ui-optimization.md)
...
- 2026-01-15: 创建产品概述文档
- 2026-01-16: 搭建前端项目基础架构
- 2026-01-19: 开发聊天面板组件
- 2026-01-20: 进行 Lighthouse 性能优化
- 2026-01-20: 切换包管理器从 pnpm 到 npm
- 2026-01-21: 创建 CLAUDE.md 配置文件
- 2026-01-21: 实现登录功能（Header + LoginModal）
- 2026-01-21: 修复登录状态同步问题（使用 React Context）
- 2026-01-21: 优化顶部导航栏和右侧 AI 面板 UI 设计
- 2026-01-21: 替换登录框 logo 为项目品牌 logo
